...
РЕАЛИЗОВАТЬ пример использования RabbitMQ, чтобы было понятно, что воспользоваться RabbitMQ в своём маленьком приложении это просто: [Установка](./RabbitMQ.pdf)  и [Примеры](./examples/readme.md) 
